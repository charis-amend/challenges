...
async function fetchDataAndRender() {
  try {
    ...
    if (response.ok) {
      ...
      const starWarsDataResults = starWarsData.results
      console.log(starWarsDataResults)

      starWarsDataResults.forEach((starWarsObject) => {
        const newCard = Card(starWarsObject)
