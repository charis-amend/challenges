...
const exampleArray = [123, "this is a string"];
...
const nestedArray = [
  ...
  10,
  true,
  ["element in array in nestedArray", 234],
];
...
fruitsWithPop.pop();
console.log(fruitsWithPop[fruitsWithPop.length - 1]);
